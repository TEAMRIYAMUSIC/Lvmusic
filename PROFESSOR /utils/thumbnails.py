...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("GOODFATHER/assets/font2.ttf", 30)
    font = ImageFont.truetype("GOODFATHER/assets/font.ttf", 30)
    title_font = ImageFont.truetype("GOODFATHER/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("GOODFATHER/assets/play_icons.png")
